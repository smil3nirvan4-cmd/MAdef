...
const mocks = vi.hoisted(() => ({
    ...
    enqueueWhatsAppContratoJob: vi.fn(),
...
vi.mock('@/lib/whatsapp/outbox/service', () => ({
    enqueueWhatsAppContratoJob: mocks.enqueueWhatsAppContratoJob,
}));
...
function req(body: unknown): NextRequest {
    return new Request('https://example.com/api/admin/avaliacoes/av1/send-contrato', {
        method: 'POST',
...
describe('POST /api/admin/avaliacoes/[id]/send-contrato', () => {
    beforeEach(() => {
        vi.clearAllMocks();
        ...
        mocks.enqueueWhatsAppContratoJob.mockResolvedValue({
            queueItemId: 'q1',
