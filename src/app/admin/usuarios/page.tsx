                            ...
                            {loading ? (
                                ...
                                filteredUsuarios.map((usuario) => (
                                    <button
                                        ...
                                        className={`w-full p-4 text-left hover:bg-gray-50 transition-colors ${selectedUser?.id === usuario.id ? 'bg-blue-50 border-l-4 border-blue-500' : ''
                                            }`}
                                    >
                                        <div className="flex items-start justify-between gap-2">
                                            <div className="min-w-0">
                                                <p className="font-medium text-gray-900 truncate">{usuario.nome}</p>
                                                <p className="text-sm text-gray-500">{formatPhone(usuario.telefone)}</p>
                                            </div>
                        ...
                        <Card noPadding>
                            ...
                            <div className="p-4 border-b border-gray-100 flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="font-semibold text-gray-900">{selectedUser.nome}</h3>
                                        <p className="text-sm text-gray-500">{formatPhone(selectedUser.telefone)}</p>
                                    </div>
                                </div>
                            ...
                            {/* Messages */}
                            <div className="p-4 bg-gray-50 max-h-[50vh] overflow-y-auto space-y-3">
