...
const DEFAULT_PROPOSTA_TEMPLATE = [
    '*MAOS AMIGAS*',
    '_Proposta Comercial_',
    '',
    'Ola, *{{nome}}*!',
    'Foi um prazer realizar a avaliacao. Com base no que conversamos, preparamos uma proposta personalizada para voce.',
    '',
    '━━━━━━━━━━━━━━━━━━━━',
    '*AVALIACAO*',
    '━━━━━━━━━━━━━━━━━━━━',
    ...
    '*INVESTIMENTO*',
    '━━━━━━━━━━━━━━━━━━━━',
    'Valor do periodo: *{{valorPeriodo}}*',
    'Investimento final: *{{investimentoTotal}}*',
    'Pagamento: {{metodosPagamento}}',
    'Parcelamento: {{formasPagamento}}',
    'Entrada: {{entrada}} + {{parcelas}}x de {{valorParcela}}',
    'Vencimento: {{dataVencimento}}',
    '{{tipoCobertura}}',
    '',
    'O PDF detalhado com escala, composicao de precos e condicoes segue em anexo.',
    '',
    '_Validade: {{validadeHoras}}h  |  Ref.: {{referencia}}_',
    '',
    'Ficamos a disposicao para esclarecer qualquer duvida.',
    '*Maos Amigas* - Cuidado que faz a diferenca.',
].join('\n');

const DEFAULT_CONTRATO_TEMPLATE = [
    '*MAOS AMIGAS*',
    '_Contrato de Servicos_',
    '',
    'Ola, *{{nome}}*.',
    'Seu contrato foi estruturado com base na avaliacao clinica realizada.',
    '',
    '━━━━━━━━━━━━━━━━━━━━',
    '*RESUMO CLINICO*',
    '━━━━━━━━━━━━━━━━━━━━',
    ...
    '{{tipoCobertura}}',
    '',
    'O contrato completo segue em anexo no PDF.',
    '',
    '_Ref.: {{referencia}}_',
    '',
    'Ficamos a disposicao para esclarecer qualquer duvida.',
